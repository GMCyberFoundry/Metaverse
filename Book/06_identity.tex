...
\item multiple usable libraries and tools
...
\item it's based on the same underlying cryptographic technology we are using elsewhere
\item it provides the identity proof that we need to validate users into a virtual space
