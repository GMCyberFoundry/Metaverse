...
\section{Ethereum}
Ethereum \cite{buterin2013ethereum} is the second most secure public blockchain (\href{https://howmanyconfs.com/}{by about 50\%}), and second most valuable by \href{https://coinmarketcap.com/}{market capitalisation} (though this comparison is somewhat stretched). It is the natural connection from Web3 to the rest of the paper, so it will be considered first.\par
