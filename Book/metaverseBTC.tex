...
\item Global training of XR production flows in XR metaverse classrooms, there might be some canny way to 'invert' the screen boundary and use the instructors IRL as the virtual set for the metaverse production team. Would be a great little proof of concept at the very least.
\item Metaverse based "hands on" hardware playrooms with guided instruction by expert system, with paid tier pop in support by an instructor
