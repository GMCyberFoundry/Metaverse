...
Referencing is in two styles; academic works and books are numeric, while opinion pieces, grey statistics, and pertinent news articles are hyperlinked in blue from the text (and might be broken). This hybrid style yields about twice the citation density of a normal PhD thesis, which is a lot.  so follow ones that are most interesting!\par 
