...
This chapter will attempt to frame the context for telepresence, and then explain the increasingly polarised options for metaverse. It's useful to identify the primitives of the product we would like to see here, so this chapter is far more a review of academic literature in the field, culminating in a proposed framework.\\
